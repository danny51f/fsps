...
class ProtoNetAlignQGPASR(nn.Module):
    ...
    def forward(self, support_x, support_y, query_x, query_y):
        ...
        if self.use_transformer:
            ...
            # 更新 query，保持原始的尺寸
            updated_query = (query_feat + weighted_prototype)/2  # 这里可以选择不同的融合方式
            ...
            similarity = [self.calculateSimilarity_trans(updated_query, prototype.squeeze(1), self.dist_method) for prototype in prototypes_new]#计算query和原型的相似性
