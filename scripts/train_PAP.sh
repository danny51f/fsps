...
SPLIT=0
#可选0和1
DATA_PATH='/home/zxd/datasets/S3DIS/blocks_bs1_s1'
...
PRETRAIN_CHECKPOINT='./log_s3disyuan/log_pretrain_s3dis_S0'
#PRETRAIN_CHECKPOINT='./log_s3dis/log_pretrain_s3dis_S1'
#PRETRAIN_CHECKPOINT='/home/zxd/fewshot/2CBR-main/log_s3dis_pretrain/log_pretrain_s3dis_S0'
N_WAY=3
K_SHOT=5
##可以改2，1或者2，5  3，1  3，5
N_QUESIES=1
